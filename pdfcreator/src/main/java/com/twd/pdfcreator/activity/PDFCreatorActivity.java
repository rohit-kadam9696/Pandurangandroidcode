package com.twd.pdfcreator.activity;
...
import com.twd.pdfcreator.R;
import com.twd.pdfcreator.utils.FileManager;
...
import com.twd.pdfcreator.views.basic.PDFPageBreakView;
...
public abstract class PDFCreatorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void createPDF(String fileName, double PDF_PAGE_WIDTH, double PDF_PAGE_HEIGHT, int pdf_margin_vertical, int pdf_margin_horizontal, final PDFUtil.PDFUtilListener pdfUtilListener) {
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams((int)(PDF_PAGE_WIDTH*72), (int) (PDF_PAGE_HEIGHT)*72);
        layoutPageParent.setLayoutParams(params);
        layoutPageParent.setPadding(pdf_margin_horizontal, pdf_margin_vertical, pdf_margin_horizontal, pdf_margin_vertical);
        ...
        createPDFFromViewList(header, footer, bodyViewList, fileName, PDF_PAGE_WIDTH, PDF_PAGE_HEIGHT, pdf_margin_vertical, pdf_margin_horizontal, new PDFUtil.PDFUtilListener() {
            @Override
     ...
     */
    private void createPDFFromViewList(final View headerView, final View footerView, @NonNull final ArrayList<View> tempViewList, @NonNull final String filename, double PDF_PAGE_WIDTH, double PDF_PAGE_HEIGHT, int pdf_margin_vertical, int pdf_margin_horizontal, final PDFUtil.PDFUtilListener pdfUtilListener) {
        tempViewList.get(tempViewList.size() - 1).post(new Runnable() {
            ...
            public void run() {
                ...
                // get height per page
                final int HEIGHT_ALLOTTED_PER_PAGE = (int) (PDF_PAGE_HEIGHT*72 - (pdf_margin_vertical * 2));
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams((int)(PDF_PAGE_WIDTH*72), (int) (PDF_PAGE_HEIGHT)*72);
                        currentPDFLayout.setLayoutParams(params);
                        currentPDFLayout.setPadding(pdf_margin_horizontal, pdf_margin_vertical, pdf_margin_horizontal, pdf_margin_vertical);
                        ...
                        PDFUtil.getInstance().generatePDF(pdfPageViewList, fileManager.createTempFileWithName(getApplicationContext(), filename + ".pdf", false).getAbsolutePath(), pdfUtilListener, PDF_PAGE_WIDTH, PDF_PAGE_HEIGHT);
                    }
                });
            }
        });
