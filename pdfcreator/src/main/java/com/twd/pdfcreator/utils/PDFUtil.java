package com.twd.pdfcreator.utils;
...
public class PDFUtil {
     ...
     */
    //private static final double PDF_PAGE_WIDTH = 8.5 * 72;
    /**
     * Page height for our PDF.
     */
    // private static final double PDF_PAGE_HEIGHT = 14 * 72;
    /**
    ...
    public final void generatePDF(final List<View> contentViews, final String filePath,
                                  final PDFUtilListener listener, double PDF_PAGE_WIDTH, double PDF_PAGE_HEIGHT) {
        // Check Api Version.
        int currentApiVersion = Build.VERSION.SDK_INT;
        if (currentApiVersion >= Build.VERSION_CODES.KITKAT) {
            // Kitkat
            new GeneratePDFAsync(contentViews, filePath, listener, PDF_PAGE_WIDTH, PDF_PAGE_HEIGHT).execute();
        } else {
            // Before Kitkat
    ...
    private static class GeneratePDFAsync extends AsyncTask<Void, Void, File> {
         ...
         * @param listener     PDFUtilListener to send callback for PDF generation.
         */
        GeneratePDFAsync(final List<View> contentViews, final String filePath, final PDFUtilListener listener, double PDF_PAGE_WIDTH, double PDF_PAGE_HEIGHT) {
            this.mContentViews = contentViews;
            this.mFilePath = filePath;
            this.mListener = listener;
            this.PDF_PAGE_WIDTH = PDF_PAGE_WIDTH;
            this.PDF_PAGE_HEIGHT = PDF_PAGE_HEIGHT;
        }
        ...
        protected File doInBackground(Void... params) {
            try {
                ...
                writePDFDocument(pdfDocument, PDF_PAGE_WIDTH, PDF_PAGE_HEIGHT);
         ...
         */
        private void writePDFDocument(final PdfDocument pdfDocument, double PDF_PAGE_WIDTH, double PDF_PAGE_HEIGHT) {
            ...
            for (int i = 0; i < mContentViews.size(); i++) {
                ...
                PdfDocument.PageInfo pageInfo = new PdfDocument.PageInfo.
                        Builder((int) (PDF_PAGE_WIDTH * 72), (int) (PDF_PAGE_HEIGHT * 72), i + 1).create();
