...
public class MultiSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
    ...
    private MultiSpinnerListenerOk listenerok;
    ...
    public void clearAll() {
        ...
        for (int i = 0; i < size; i++) {
            KeyPairBoolData item = items.get(i);
    ...
    public boolean performClick() {
        ...
        if (isSearchEnabled) {
            ...
            if (!defaultSearch.equals("")) {
                adapter.getFilter().filter(defaultSearch);
            }
        ...
        if (isShowSelectAllButton && limit == -1) {
            builder.setNeutralButton("सर्व निवडा", (dialog, which) -> {
                ...
                if (listenerok != null)
                    listenerok.onOkClickLister(getSelectedIds(), getSelectedItems());
        ...
        builder.setPositiveButton("ठीक", (dialog, which) -> {
    ...
    public void setItems(List<KeyPairBoolData> items, MultiSpinnerListener listener, MultiSpinnerListenerOk listenerOk) {
                    ...
                    if (constraint == null || constraint.length() == 0) {
                        ...
                        for (int i = 0; i < mOriginalValues.size(); i++) {
                            ...
                            if (data.toLowerCase().contains(constraint.toString())) {
                                //  if (!defaultSearch.equals(""))
                                if (data.toLowerCase().contains(defaultSearch))
