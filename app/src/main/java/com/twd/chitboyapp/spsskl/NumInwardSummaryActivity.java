...
public class NumInwardSummaryActivity extends AppCompatActivity  implements View.OnClickListener, RetrofitResponse, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_num_inward_summary);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.mnupdf) {
            ...
            ConstantFunction cf = new ConstantFunction();
            String data[] = cf.getSharedPrefValue(NumInwardSummaryActivity.this, new String[]{getResources().getString(R.string.prefprintersetting)}, new String[]{String.format(getResources().getString(R.string.defaultJson), getResources().getString(R.string.myfactory))});
            ...
            PDFBody body = pdf.getBodyFromView(NumInwardSummaryActivity.this, false, data[0], pdfTablePOJO);

            PdfCreatorExampleActivity.pdfBody = body;
            Intent intent = new Intent(NumInwardSummaryActivity.this, PdfCreatorExampleActivity.class);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btnsubmit) {
            ...
            String action = getResources().getString(R.string.actioninwardsummary);
            Activity activity = NumInwardSummaryActivity.this;
            ConstantFunction cf = new ConstantFunction();
            ...
            handleRetrofit.handleRetrofit(call2, NumInwardSummaryActivity.this, RequestEnum.SUMMARYREPORT, servlet, activity, versioncode);
        }
    }
